package com.netflix.cloud.constants;

public final class Constants {

    public static final String PLAYLIST_RESOURCE_PATH = "/playlists";

    public static final String PLAYLIST_CONCURRENT_RESOURCE_PATH = "/concurrent";
    ...
    public static final String PLAYLIST_COMPUTATION_ERROR = "Error encountered computing playlist data";
